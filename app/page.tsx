  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-gray-800 text-white flex flex-col items-center justify-center p-6">
      ...
      <div className="flex gap-6 mt-8">
        <Link href="/projects">
          <span className="px-6 py-3 bg-blue-500 hover:bg-blue-600 text-white font-bold rounded-lg shadow-lg transition duration-300 cursor-pointer">
            View My Projects 🚀
          </span>
        </Link>
        <Link href="/experience">
          <span className="px-6 py-3 bg-gray-700 hover:bg-gray-600 text-white font-bold rounded-lg shadow-lg transition duration-300 cursor-pointer">
            Experience & Resume 📄
          </span>
        </Link>
      </div>
      ...
      <div className="flex gap-12 mt-16 opacity-80">
        {/* GitHub */}
